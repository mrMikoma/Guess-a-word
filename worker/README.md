# Redis and Python 3 worker node setup

## Setting up Environment Variables and Running Docker Compose

This guide will walk you through the process of setting up environment variables using a `.env` file and running Docker Compose to deploy your database and node.
